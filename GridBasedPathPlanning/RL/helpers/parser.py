...
def parse_args():
    ...
    parser.add_argument('--method', type=str, choices=['dqn', 'qnet', 'mppo'], default='mppo',
    ...
    parser.add_argument("--max_amr", type=int, default=10,
        help="the maximum number of autonomous mobile robots")
    ...
    parser.add_argument("--curriculum", type=int, default=100,
        help="control how many times a start-goal pair repeats befare a new is generated")
    ...
    parser.add_argument("--generate", type=lambda x: bool(strtobool(x)), default=False, nargs="?", const=True,
        help="Define if the train is for generating data or not")
