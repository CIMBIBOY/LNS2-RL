...
def save_array_as_png(array, filename="output.png"):
    """
    Save a NumPy array as a PNG image.

    Parameters:
        array (numpy.ndarray): The array to save as an image.
        filename (str): The name of the output file (default: "output.png").
    """
    if array.dtype != np.uint8:
        raise ValueError("Array must be of type uint8 for proper image representation.")
